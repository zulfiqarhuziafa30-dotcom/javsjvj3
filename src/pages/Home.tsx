      ...
      <section className="py-20 md:py-28 px-6 border-t border-white/10">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Capability 01 */}
            <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:border-white/20 transition-all duration-300">
              <div>
                ...
                <span className="text-xs font-mono uppercase tracking-widest text-zinc-400">01 / Tech</span>
              ...
              <a href="/services#development" className="text-sm font-semibold text-zinc-300 hover:text-white flex items-center gap-2 group transition-colors">
            ...
            <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:border-white/20 transition-all duration-300">
              <div>
                ...
                <span className="text-xs font-mono uppercase tracking-widest text-zinc-400">02 / Design</span>
              ...
              <a href="/services#creative" className="text-sm font-semibold text-zinc-300 hover:text-white flex items-center gap-2 group transition-colors">
                <span>View Details</span>
                <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
              </a>
            </div>
            ...
            <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:border-white/20 transition-all duration-300">
              <div>
                ...
                <span className="text-xs font-mono uppercase tracking-widest text-zinc-400">03 / Growth</span>
              ...
              <a href="/services#growth" className="text-sm font-semibold text-zinc-300 hover:text-white flex items-center gap-2 group transition-colors">
                <span>View Details</span>
                <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
              </a>
            </div>
