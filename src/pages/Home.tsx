      ...
      <section className="py-20 md:py-28 px-6 border-t border-white/10">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Capability 01 */}
            <Reveal delay={0.1}>
              <div className="bg-surface border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:border-white/20 transition-all duration-300 shadow-sm hover:shadow-md h-full">
                <div>
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
            ...
            <Reveal delay={0.1} className="shrink-0">
              <Button href="/our-process" variant="outline">
                Full Process
              </Button>
            </Reveal>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Reveal key={step.num} delay={idx * 0.1}>
                <div className="bg-surface border border-white/10 rounded-2xl p-6 shadow-sm h-full">
